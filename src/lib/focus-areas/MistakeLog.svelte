...
>
	...
	<!-- Title -->
	<h3 class="text-fg font-Inter text-base font-bold">Mistake Log</h3>

	<!-- Description -->
	<p class="text-fg-muted font-Poppins max-w-sm text-sm">
		Try reviewing your mistake log of wrong/unattempted question for improving your score.
	</p>
